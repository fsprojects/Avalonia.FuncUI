...
module UniformGrid =
    ...
    type UniformGrid with
        ...
        /// </summary>
        static member columns<'t when 't :> UniformGrid>(value: int) : Attr<'t> =
        ...
        /// </summary>
        static member rows<'t when 't :> UniformGrid>(value: int) : Attr<'t> =
        ...
        /// </summary>
        static member firstColumn<'t when 't :> UniformGrid>(value: int) : Attr<'t> =
