...
module TabControl =
    ...
    type TabControl with
        ...
        static member selectedContentTemplate<'t when 't :> TabControl>(value: IDataTemplate) : Attr<'t> =
