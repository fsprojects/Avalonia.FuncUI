...
module ScrollViewer  =
    ...
    type Control with
        ...
        /// </summary>
        static member verticalScrollBarVisibility<'t when 't :> Control>(value: ScrollBarVisibility) : Attr<'t> =
        ...
        /// </summary>
        static member horizontalScrollBarVisibility<'t when 't :> Control>(value: ScrollBarVisibility) : Attr<'t> =
    ...
    type ScrollViewer with
        ...
        static member allowAutoHide<'t when 't :> ScrollViewer>(value: bool) : Attr<'t> =
        ...
        static member smallChange<'t when 't :> ScrollViewer>(value: Size) : Attr<'t> =
        ...
        /// </summary>
        static member viewport<'t when 't :> ScrollViewer>(value: Size) : Attr<'t> =
            AttrBuilder<'t>.CreateProperty<Size>(ScrollViewer.ViewportProperty, value, ValueNone)

        /// <summary>
        /// Sets the vertical scrollbar value.
        /// </summary>
        static member verticalScrollBarValue<'t when 't :> ScrollViewer>(value: double) : Attr<'t> =
        ...
        /// </summary>
        static member horizontalScrollBarValue<'t when 't :> ScrollViewer>(value: double) : Attr<'t> =
