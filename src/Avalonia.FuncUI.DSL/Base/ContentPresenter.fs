...
module ContentPresenter =
    ...
    type ContentPresenter with
        static member background<'t when 't :> ContentPresenter>(brush: IBrush) : IAttr<'t> =
            AttrBuilder.CreateProperty<'t, IBrush>(ContentPresenter.BackgroundProperty, brush, ValueNone)
        ...
        static member borderBrush<'t when 't :> ContentPresenter>(brush: IBrush) : IAttr<'t> =
            AttrBuilder.CreateProperty<'t, IBrush>(ContentPresenter.BorderBrushProperty, brush, ValueNone)
        ...
        static member borderThickness<'t when 't :> ContentPresenter>(value: Thickness) : IAttr<'t> =
            AttrBuilder.CreateProperty<'t, Thickness>(ContentPresenter.BorderThicknessProperty, value, ValueNone)
        ...
        static member cornerRadius<'t when 't :> ContentPresenter>(value: CornerRadius) : IAttr<'t> =
            AttrBuilder.CreateProperty<'t, CornerRadius>(ContentPresenter.CornerRadiusProperty, value, ValueNone)
        ...
        static member child<'t when 't :> ContentPresenter>(value: IView option) : IAttr<'t> =
            AttrBuilder.CreateContentSingle(ContentPresenter.ChildProperty, value)
        ...
        static member content<'t when 't :> ContentPresenter>(value: IView option) : IAttr<'t> =
            AttrBuilder.CreateContentSingle(ContentPresenter.ContentProperty, value)
        ...
        static member contentTemplate<'t when 't :> ContentPresenter>(template: IDataTemplate) : IAttr<'t> =
            AttrBuilder.CreateProperty<'t, IDataTemplate>(ContentPresenter.ContentTemplateProperty, template, ValueNone)
            
        static member horizontalContentAlignment<'t when 't :> ContentPresenter>(value: HorizontalAlignment) : IAttr<'t> =
            AttrBuilder.CreateProperty<'t, HorizontalAlignment>(ContentPresenter.HorizontalContentAlignmentProperty, value, ValueNone)
            
        static member verticalContentAlignment<'t when 't :> ContentPresenter>(value: VerticalAlignment) : IAttr<'t> =
            AttrBuilder.CreateProperty<'t, VerticalAlignment>(ContentPresenter.VerticalContentAlignmentProperty, value, ValueNone)
            
        static member padding<'t when 't :> ContentPresenter>(value: Thickness) : IAttr<'t> =
            AttrBuilder.CreateProperty<'t, Thickness>(ContentPresenter.PaddingProperty, value, ValueNone)
