...
module ColorPickerDSL =
    ...
    type ColorPicker with
        ...
        static member horizontalContentAlignment<'t when 't :> ColorPicker>(value: HorizontalAlignment) =
            AttrBuilder<'t>
                .CreateProperty<HorizontalAlignment>(ColorPicker.HorizontalContentAlignmentProperty, value, ValueNone)
        ...
        static member verticalContentAlignment<'t when 't :> ColorPicker>(value: VerticalAlignment) =
            AttrBuilder<'t>
                .CreateProperty<VerticalAlignment>(ColorPicker.VerticalContentAlignmentProperty, value, ValueNone)
